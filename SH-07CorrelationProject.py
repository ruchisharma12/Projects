...
heading= Label(top, text="Correlation In Python",font=('Helvetica bold',20)).place(x=150,y=40)
...
result = Label(top, text = "", textvariable=output, fg="green", font=('Helvetica bold',15)).place(x = 170,y = 420)
